...
class ModuleReportPlugin(Plugin):
    ...
    def on_solver_finish(self, result: Dict[str, Any]):
        ...
        modules_path.write_text(json.dumps(modules_payload, ensure_ascii=False, indent=2), encoding="utf-8")
        ...
        bias_json_path.write_text(json.dumps(bias_payload, ensure_ascii=False, indent=2), encoding="utf-8")

        if bool(self.cfg.write_bias_markdown):
            bias_md_path.write_text(self._render_bias_markdown(bias_payload), encoding="utf-8")
