...
from nsgablack.plugins.solver_backends.mlblack_symbolic_consensus_backend import MlblackSymbolicConsensusBackend
...
from case_scaffold.pipeline.representation import build_representation_pipeline
...
def build_solver_from_args(args: argparse.Namespace) -> ComposableSolver:
    ...
    pipeline = build_representation_pipeline(problem, args)
