...
class LearnableConvComponentSearchProblem(BlackBoxProblem):
    def __init__(self, cfg: LearnableConvComponentSearchConfig, *, output_dir: str | Path) -> None:
        ...
        from examples.cases.learnable_conv_component_demo.case_scaffold.pipeline import available_symbolic_kernel_basis  # type: ignore
    ...
    def decode_structure_bundle(self, x: np.ndarray) -> dict[str, Any]:
        _ensure_mlblack_path()
        from examples.cases.learnable_conv_component_demo.case_scaffold.pipeline import build_symbolic_kernel_object  # type: ignore
