...
- nsgablack 提供 outer search 语义，搜索内层训练超参数。
- mlblack 提供 inner train-flow assembly 和模型评估语义。
...
```powershell
python examples/cases/mlblack_nested_scaffold/run_project.py --generations 1 --batch-size 4 --fold-col test_fold_1
```

Fuller search：

```powershell
python examples/cases/mlblack_nested_scaffold/run_project.py --generations 6 --batch-size 10 --fold-col test_fold_1
```
