...
def main():
    ...
    for mode in modes:
        ...
        solver = build_solver(
            X, y_true, mode=mode, pop_size=args.pop_size, max_steps=args.max_steps
        )
