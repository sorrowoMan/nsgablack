"""Bounded-run wrapper around the real ComposableSolver."""
        ...
        return replace(
            ...
            metadata={
                **dict(result.metadata),
                "calibration_target": self.problem.target,
                "case_identity": self.case_runtime.identity.as_dict(),
            },
        )
