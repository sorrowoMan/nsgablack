"""Formal L0/L1/L2 assembly for material-domain design search.
python examples/cases/supply_adjustment_nested/solver/run_blacklist_case.py `
  --no-baseline `
...
def main(argv: Optional[list] = None) -> None:
    ...
    if bool(args.ui):
        launch_from_builder(lambda: _build_solver(args), entry_label="solver/blacklist_assembly.py:build_solver")
        return
