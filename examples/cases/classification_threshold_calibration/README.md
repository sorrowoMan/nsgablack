...
`classification_threshold_calibration` 是双框架能力 case：nsgablack 搜索 classification operating point，mlblack 负责 probability-model evaluation 和 classification metrics。
...
关键点是：nsgablack 优化 decision policy variables，而 mlblack 保持 classification metric semantics 的所有权。
