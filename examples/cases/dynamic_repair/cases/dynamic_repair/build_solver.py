...
def build_solver(run_id: str | None = None, *, strategy: str | None = None, quickstart: bool = False, resource_context=None, component_overrides=None):
    ...
    # DynamicRepair: two-stage repair adapts over generations
    # Stage 1 (gen 0-19): wide clip [-2,2]; Stage 2 (gen 20+): tight clip [-1,1]
    ...
    solver.representation_pipeline.set_repair(DynamicRepair([(0, repair_stage1), (20, repair_stage2)]))
