...
class DemoSphere(BlackBoxProblem):
    ...
    def evaluate(self, candidate):
        ...
        if candidate.ndim > 1:
            return np.sum(candidate * candidate, axis=1)
...
def main() -> None:
    out_dir = os.path.abspath(os.path.join("runs", "end_to_end_legacy_demo"))
