...
def _build_l2_solver() -> ComposableSolver:
    ...
    l2.max_steps = 1
    l2.pop_size = 2
    l2.problem.inner_runtime_evaluator = TaskInnerRuntimeEvaluator(
        config=InnerRuntimeConfig(source_layer="L3", target_layer="L2")
    )
    return l2
...
def build_solver() -> ComposableSolver:
    ...
    l1.max_steps = 1
    l1.pop_size = 1
    l1.problem.inner_runtime_evaluator = TaskInnerRuntimeEvaluator(
