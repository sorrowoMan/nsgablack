...
class NgspiceOuterProblem(BlackBoxProblem):
    ...
    def build_inner_problem(self, x, eval_context):
        _ = (x, eval_context)
        # Inner runtime evaluator requires a non-empty inner task context.
...
def build_solver() -> ComposableSolver:
    ...
    inner_runtime = TaskInnerRuntimeEvaluator(
    ...
    solver.problem.inner_runtime_evaluator = inner_runtime
    return solver
