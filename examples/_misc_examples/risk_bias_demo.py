...
def build_solver():
    ...
    solver.set_bias_enabled(True)
    solver.register_evaluation_provider(MonteCarloEvaluationProviderPlugin(MonteCarloEvaluationConfig(mc_samples=12, reduce="mean")).create_provider())
...
def main():
    ...
    print("ËøêË°åÁä∂ÊÄ?", result.get("status"))
