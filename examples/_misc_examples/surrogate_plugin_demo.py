"""
Surrogate evaluation provider demo.

Goal:
- show how a capability-layer L4 provider can reduce expensive true evaluations
...
from nsgablack.plugins import SurrogateEvaluationConfig, SurrogateEvaluationProviderPlugin  # noqa: E402
...
def _build_solver(*, enable_surrogate: bool, out_dir: str, run_id: str) -> ComposableSolver:
    ...
    if enable_surrogate:
        ...
        plugin = SurrogateEvaluationProviderPlugin(config=cfg, model_type="rf", online_training=True)
