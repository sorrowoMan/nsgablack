...
from nsgablack.plugins import BenchmarkHarnessPlugin, ModuleReportPlugin, MultiFidelityEvaluationProviderPlugin, MultiFidelityEvaluationConfig
...
def build_solver():
    ...
    solver.register_evaluation_provider(MultiFidelityEvaluationProviderPlugin(config=cfg).create_provider())
