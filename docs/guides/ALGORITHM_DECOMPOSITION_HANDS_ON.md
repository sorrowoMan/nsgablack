...
6. `docs/guides/DECOUPLING_PROBLEM.md`
7. `docs/guides/DECOUPLING_REPRESENTATION.md`
8. `docs/guides/DECOUPLING_ADAPTER.md`
9. `docs/guides/DECOUPLING_BIAS.md`
10. `docs/guides/DECOUPLING_CAPABILITIES.md`
