...
```bash
python nsgablack/examples/blank_solver_plugin_demo.py
python nsgablack/examples/blank_vs_composable_demo.py
python nsgablack/examples/composable_solver_fusion_demo.py
python nsgablack/examples/end_to_end_workflow_demo.py
