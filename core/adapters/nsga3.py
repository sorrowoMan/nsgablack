...
class NSGA3Adapter(NSGA2Adapter):
    ...
    def __init__(self, config: Optional[NSGA3Config] = None, name: str = "nsga3", priority: int = 0) -> None:
        super().__init__(config=(config or NSGA3Config()), name=name, priority=priority)
