...
# Optional dependency: scikit-learn (only required for ML-related toy problems).
try:  # pragma: no cover
...
class NeuralNetworkHyperparameterOptimization(BlackBoxProblem):
    def __init__(self, dimension=4):
        ...
        if make_classification is None or MLPClassifier is None or cross_val_score is None or StandardScaler is None:
            raise ImportError(
                "NeuralNetworkHyperparameterOptimization requires scikit-learn. Install with: pip install scikit-learn"
            )
        self.bounds = {
            'x0': [10, 200],
            'x1': [10, 200],
